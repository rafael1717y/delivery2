...
- 🎯 Entry points to execute your program using `python -m <delivery2>` or `$ delivery2` with basic CLI argument parsing.
...
---
# delivery2 Flask Application

Awesome delivery2 created by rafael1717y
...
```bash
git clone https://github.com/rafael1717y/delivery2 delivery2
cd delivery2
make install
```
...
```bash
delivery2 create-db   # run once
delivery2 populate-db  # run once (optional)
delivery2 add-user -u admin -p 1234  # ads a user
delivery2 run
```
